...
def validate_tree_node(node, left_bound, right_bound):
    ...
    return (
        ...
        and validate_tree_node(node.left, left_bound, node.data)
        and validate_tree_node(node.right, node.data, right_bound)
    )
...
class Test(unittest.TestCase):
    def test_validate_tree(self):
        ...
        tree1 = Node(5, Node(3, Node(1), Node(4)), Node(6), Node(8, None, Node(9)))
