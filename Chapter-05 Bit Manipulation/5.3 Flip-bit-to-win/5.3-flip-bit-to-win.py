# Determine the longest sequence of ls attainable by flipping up to one digit.
...
class Test(unittest.TestCase):
    def test_longest_sequence_after_flip(self):
        ...
        self.assertEqual(longest_sequence_after_flip(0b1111100), 7)
